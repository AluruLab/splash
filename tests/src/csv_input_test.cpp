...
int main(int argc, char* argv[]) {
	...
	if (common_params.random) {
		...
		if (app_params.reader_method == app_parameters::reader_type::delim_str) {
			input = read_csv_matrix<double>(common_params.input, 
				common_params.num_vectors, common_params.vector_size,
				genes, samples, app_params.atof_method);

		} else {
			input = read_csv_matrix_fast<double>(common_params.input, 
				common_params.num_vectors, common_params.vector_size,
				genes, samples, app_params.atof_method);
		}
